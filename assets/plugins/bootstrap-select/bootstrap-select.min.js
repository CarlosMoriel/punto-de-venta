...
!(function (e, t) {
	...
	!(function (z) {
		...
		function v(e, t) {
			...
			if (-1 !== z.inArray(i, t))
				return (
					-1 === z.inArray(i, l) || Boolean(e.nodeValue.match(r) || e.nodeValue.match(a))
				);
			for (
		...
		var _ = new RegExp(P + "|" + W),
			...
			Y = function (e, t) {
				...
				if (e.content) n.innerHTML = e.content;
					...
					e.subtext &&
						(((i = F.subtext.cloneNode(!1)).textContent = e.subtext), n.appendChild(i));
				}
				if (!0 === t)
			...
			Z = function (e) {
				...
				return (
					e.subtext &&
						(((t = F.subtext.cloneNode(!1)).textContent = e.subtext), s.appendChild(t)),
					F.fragment.appendChild(s),
					F.fragment
				);
			},
							...
							(o =
								...
								(null === this.options.liveSearchPlaceholder
									...
									: ' placeholder="' +
									  ...
									  '"') +
								' role="textbox" aria-label="Buscar"></div>'),
						this.multiple &&
					...
					function x(e, t) {
						if (
							...
							t.display && (r += t.display.length),
								...
								t.icon && (r += 1),
								c < r &&
									((c = r), (a.selectpicker.view.widestOption = v[v.length - 1]));
						}
					}
					function i(e, t) {
						var i = t[e],
				...
				setSize: function (e) {
					if (
						...
						if (
							...
							var o = i.$element[0];
							"number" == typeof (t = (o.options[o.selectedIndex] || {}).liIndex) &&
								!1 !== i.options.size &&
								(n =
